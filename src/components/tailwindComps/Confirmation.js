...
export default function Example(props) {
  ...
  return (
    ...
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="fixed z-20 inset-0 overflow-y-auto" onClose={confirm}>
...
<div className="ml-3">
    <p className="mt-2 text-sm text-gray-700 sm:mt-4">
            ...
            </div> : <div className="relative z-30 bottom-32 inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
            <div>
            ...
            <div className="mt-3 text-center sm:mt-5">
              <Dialog.Title as="h3" className="text-lg leading-6 font-medium text-gray-900">
                Thanks for joining our beta testing program!
              </Dialog.Title>
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                 We will reach out shortly to set everything up with you.
                </p>
              </div>
            </div>
          </div>
