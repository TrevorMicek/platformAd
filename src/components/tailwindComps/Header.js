            ...
            <div className="mt-0">
              ...
              <div className="mt-6 sm:max-w-xl">
                ...
                <p className="mt-6 text-xl text-gray-200">
                  Introducing: <span className="text-orange">Eclipse Builder</span> - no code, beautiful components and faster page load times. 0 tech skills needed.
                </p>
              </div>
              ...
              <div className="relative top-4 mt-4">* all participants get a free website</div>
            </div>
