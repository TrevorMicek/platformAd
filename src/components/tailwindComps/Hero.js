        ...
        <div className="pt-10 bg-bg sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden">
          <div className="mx-auto max-w-7xl lg:px-8">
            ...
            <button
              ...
              >
              <Link to="/pricing" className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Get a site now</Link>
              </button>
              ...
              <div className="mt-12 sm:-mb-48 lg:m-0 lg:relative">
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
                  ...
                  <img
                    ...
                    src="https://res.cloudinary.com/websites-by-trevor/image/upload/v1647041444/techBG_mwbdce.jpg"
